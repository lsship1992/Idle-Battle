...
public class InfoItemPersonScript : MonoBehaviour
{
    ...
    public void Snit()
    {
        ClientSend.ItemPersonUserUpdate(id, -1);
        if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Book")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[8].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[8].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Helmet")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[0].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[0].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Armor")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[1].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[1].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Gloves")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[2].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[2].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Bots")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[3].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[3].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Weapon")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[4].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[4].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Rings")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[5].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[5].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Earrings")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[6].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[6].GetComponent<SelectItemScript>().speed_proc = 0;
        ...
        else if (GameControll.instance.personPanel.GetComponent<PersControlScript>().nameItem == "Necklace")
        {
            ...
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[7].GetComponent<SelectItemScript>().defens_proc = 0;
            GameControll.instance.personPanel.GetComponent<PersControlScript>().Item[7].GetComponent<SelectItemScript>().speed_proc = 0;
